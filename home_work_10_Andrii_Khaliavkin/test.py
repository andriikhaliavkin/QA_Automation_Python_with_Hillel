...
def test_increase_experience():
    e = Employee.Employee("John Snow", "Crown", 100_500, 20)
    e.increase_experience()
    assert e.experience == 21


def test_change_position():
    e = Employee.Employee("John Snow", "Crown", 100_500, 20)
    e.change_position("Lanister")
    assert e.position == "Lanister"
