...
def test_transcript_the_amount_of_money(test_input, expected):
    assert library.transcript_the_amount_of_money(test_input) == expected


@pytest.mark.parametrize("test_input, expected", [(1, "1 гривня"), (5, "5 гривень"), (22, "22 гривні"), (21, "21 гривня")])
def test_transcript_the_number_of_banknotes(test_input, expected):
    assert library.transcript_the_number_of_banknotes(test_input) == expected


@pytest.mark.parametrize("test_input, expected", [(1, "1 копійка"), (5, "5 копійок"), (2, "2 копійки"), (12, "12 копійок")])
def test_transcript_the_number_of_coins(test_input, expected):
